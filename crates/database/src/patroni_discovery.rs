...
impl PatroniDiscovery {
    ...
    #[cfg(test)]
    pub async fn set_cluster_state_for_testing(
        &self,
...
mod tests {
    ...
    fn create_test_member(name: &str, role: &str, lag: Option<i64>) -> ClusterMember {
        ClusterMember {
            name: name.to_string(),
    ...
    async fn test_get_replicas_by_lag() {
        ...
        assert_eq!(replicas[0].name, "replica2"); // 10
        assert_eq!(replicas[1].name, "replica1"); // 100
        assert_eq!(replicas[2].name, "replica3"); // None (MAX)
    }
    ...
    async fn test_round_robin_selection() {
        ...
        let r3 = discovery.get_read_replica_round_robin(2).await.unwrap();

        assert_eq!(r1.name, "replica1");
        assert_eq!(r2.name, "replica2");
        assert_eq!(r3.name, "replica1");
    }
