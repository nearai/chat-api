...
impl AgentRepository for PostgresAgentRepository {
        ...
        let row = client
            .query_one(
                "INSERT INTO agent_instances (user_id, instance_id, name, type, public_ssh_key, instance_url, instance_token, gateway_port, dashboard_url, agent_api_base_url)
                 ...
                 RETURNING id, user_id, instance_id, name, type, public_ssh_key, instance_url, instance_token, gateway_port, dashboard_url, agent_api_base_url, created_at, updated_at",
    ...
    async fn get_instance(&self, instance_id: Uuid) -> anyhow::Result<Option<AgentInstance>> {
        ...
        let row = client
            .query_opt(
                "SELECT id, user_id, instance_id, name, type, public_ssh_key, instance_url, instance_token, gateway_port, dashboard_url, agent_api_base_url, created_at, updated_at
